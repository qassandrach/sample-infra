...
# vpc peering dari kcd-project-3 (default) ke kcd-project-1 (default)
resource "google_compute_network_peering" "peering-to-kcd-project-1" {
  name         = "peering-to-kcd-project-1"
  network      = "https://www.googleapis.com/compute/v1/projects/kcd-project-3/global/networks/default"
